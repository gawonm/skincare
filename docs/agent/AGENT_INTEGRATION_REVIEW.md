...
> 역사 문서: 이 문서는 2026-09-11 기준 검토를 보존한다. 현재 NIA Case·2-Layer RAG·최종 v2
> DB 통합 상태는 [2026-09-20 작업 합본](RAG_YK/2026-09-20_2324_NIA_CASE_RAG_INTEGRATION_WORKLOG.md)을 우선한다.
