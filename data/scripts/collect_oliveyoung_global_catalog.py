...
사용법:
    uv run python -m data.scripts.collect_oliveyoung_global_catalog
    uv run python -m data.scripts.collect_oliveyoung_global_catalog --max-new-products 20  # 검증용 소규모 실행
"""
...
from data.scripts.catalog_eligibility_policy import CatalogEligibilityPolicy
from data.scripts.image_downloader import ImageDownloader
from data.scripts.oliveyoung_global_catalog_crawler import OliveYoungGlobalCatalogCrawler
from data.scripts.oliveyoung_global_category_client import OliveYoungGlobalCategoryClient
