...
먼저 `data.scripts.import_kcia_ingredients` 로 `IngredientMaster` 를 채워야 한다. 매칭 후보가
...
from data.scripts.knowledgedata_importer import KnowledgedataImporter
from data.scripts.knowledgedata_parser import KnowledgedataParser
